...
public final class ResponseHandler {
    ...
    public static ResponseEntity<ResponseObject> handleRedirect(String url, String cookieValue) {
        try {
            URI targetUri = new URI(url);
            if (cookieValue != null) {
                ResponseCookie cookie = ResponseCookie.from("client_id", cookieValue)
                        .httpOnly(true)
                        .secure(true)
                        .sameSite("None")
                        .path("/")
